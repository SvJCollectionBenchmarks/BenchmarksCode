...
public class J_Profile1AllSequencesLastIndexOf_20220501200447930 {
	...
	public void JArraySequence(Blackhole bh) {
		...
		bh.consume(collection.lastIndexOf(143.0));
		bh.consume(collection.lastIndexOf(5.0));
		...
		bh.consume(collection.lastIndexOf(46.0));
		bh.consume(collection.lastIndexOf(61.0));
		bh.consume(collection.lastIndexOf(148.0));
		bh.consume(collection.lastIndexOf(56.0));
		...
		bh.consume(collection.lastIndexOf(176.0));
		bh.consume(collection.lastIndexOf(146.0));
		bh.consume(collection.lastIndexOf(117.0));
		bh.consume(collection.lastIndexOf(171.0));
		bh.consume(collection.lastIndexOf(171.0));
		bh.consume(collection.lastIndexOf(107.0));
		bh.consume(collection.lastIndexOf(78.0));
